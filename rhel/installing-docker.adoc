...
sidebar: sidebar 
keywords:  
summary: StorageGRID 시스템은 Red Hat Enterprise Linux 또는 CentOS에서 Docker 컨테이너 모음으로 실행됩니다. StorageGRID를 설치하기 전에 Docker를 설치해야 합니다. 
---
= Docker 설치 중
:allow-uri-read: 
:icons: font
...
[role="lead"]
StorageGRID 시스템은 Red Hat Enterprise Linux 또는 CentOS에서 Docker 컨테이너 모음으로 실행됩니다. StorageGRID를 설치하기 전에 Docker를 설치해야 합니다.
