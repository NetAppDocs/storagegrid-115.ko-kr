...
summary: 'Objects Lost * 경고와 레거시 손실된(손실된 개체) 경보가 트리거되면 즉시 조사해야 합니다. 영향을 받는 개체에 대한 정보를 수집하고 기술 지원 부서에 문의하십시오.' 
---
= 분실된 물체를 조사 중입니다
:allow-uri-read: 
:icons: font
...
link:troubleshooting-storagegrid-system.html["잠재적으로 손실된 개체를 검색 및 복원합니다"]
