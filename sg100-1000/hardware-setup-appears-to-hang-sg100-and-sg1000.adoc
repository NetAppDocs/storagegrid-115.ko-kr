...
.관련 정보
link:viewing-boot-up-codes-for-appliance-sg100-and-sg1000.html["제품의 부팅 코드를 봅니다"]

link:viewing-error-codes-for-sg1000-controller-sg100-and-sg1000.html["어플라이언스에 대한 오류 코드를 봅니다"]
